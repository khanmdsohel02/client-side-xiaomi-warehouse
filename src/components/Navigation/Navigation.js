...
const Navigation = () => {
  ...
  <Navbar.Collapse id="responsive-navbar-nav">
     <Nav className="mx-auto me-3 ps-5 menu-items">
      ...
      <Nav.Link as={Link} to="/about" className='item  '>ABOUT US</Nav.Link>
      <Nav.Link as={Link} to="/blog" className='item'>MY BLOG</Nav.Link>
        ...
        <NavDropdown.Item  className='text-center dropdown-item' as={Link} to="/additem">ADD ITEM</NavDropdown.Item>
